...
const AddUpDataComponent: React.FC<ModalFormProps> = props => {
  const { modalVisible, form, onSubmit, onCancel, confirmLoading, defulat = {} ,user} = props;
  ...
  const addFormPlugin2 = [
    {
      type: 'input',
      label: '邀请人',
      key: 'inviterUserName',
      validator: validator.onlyRequier,
      defulatVal: user.userName,
      placeholder: '请输入邀请人',
    },
  ];
  ...
  return (
    ...
    >
      ...
      {helpers.isJudge(hasModity)(
          null,
          <GenerateFormCompoents formItems={addFormPlugin2} form={form} />,
        )}
